 ...
 * @see app/Http/Controllers/Admin/PermissionController.php:25
 ...
 * @see app/Http/Controllers/Admin/PermissionController.php:52
 ...
 * @see app/Http/Controllers/Admin/PermissionController.php:100
 ...
 * @see app/Http/Controllers/Admin/PermissionController.php:118
 * @route '/admin/permissions/{permission}'
 */
export const update = (args: { permission: number | { id: number } } | [permission: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @see app/Http/Controllers/Admin/PermissionController.php:141
 * @route '/admin/permissions/{permission}'
 */
