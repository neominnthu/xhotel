...
/**
* @see \App\Http\Controllers\Api\GuestController::merge
 * @see app/Http/Controllers/Api/GuestController.php:73
 * @route '/api/v1/guests/{guest}/merge'
 */
...
const GuestController = { index, store, show, update, merge }
